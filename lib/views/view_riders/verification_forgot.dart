...
import 'package:hatidapp/views/view_riders/new_password.dart';
import 'package:http/http.dart' as http;

class VerificationForgotRider extends StatefulWidget {
  final email;
  final String otp;
  VerificationForgotRider(this.email, this.otp);
  VerificationPageState createState() =>
      VerificationPageState(this.email, this.otp);
}

class VerificationPageState extends State<VerificationForgotRider> {
  final email;
  final String myOtp;
